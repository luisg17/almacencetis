            ...
            echo ' <tr>
                    ...
                    <td>
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-warning btnEditarPresentacion" idPresentacion="'.$value["id"].'" data-toggle="modal" data-target="#modalEditarCategoria"><i class="fa fa-pencil"></i></button>';

                        if($_SESSION["perfil"] == "Administrador"){

                          echo '<button class="btn btn-danger btnEliminarPresentacion" idPresentacion="'.$value["id"].'"><i class="fa fa-times"></i></button>';
    ...
    <div class="modal-content">
      ...
      <form role="form" method="post">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="nuevaPresentacion" placeholder="Ingresar presentacion" required>
        ...
        <?php
          ...
          $crearPresentacion = new ControladorPresentaciones();
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <?php
          ...
          $editarPresentacion = new ControladorPresentaciones();
...
<?php
  ...
  $borrarPresentacion = new ControladorPresentaciones();
